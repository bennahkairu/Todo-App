<template>
  <header class="relative">
    <picture>
      ...
      <source
        ...
        :srcset="getSrc(`BG-MOBILE-${isDark ? 'DARK' : 'LIGHT'}.JPG`)"
      />
      <source
        media="(min-width: 600px)"
        :srcset="getSrc(`bg-desktop-${isDark ? 'dark' : 'light'}.jpg`)"
      />
      <img
  ...
  <footer class="container relative z-10 mt-6 py-6">
    <h6
      class="text-center text-sm font-medium text-gray-blue-600 dark:text-gray-blue-800"
    >
